...
{
    public class ITClearanceRequestDAL
    {
        ...
        public async Task<ResponseModel<object>> CreateITClearanceRequest(System.Web.Mvc.FormCollection form, UserData user)
        {
            ...
            int appRowIdInput = Convert.ToInt32(form["AppRowId"]);
            ...
            try
            {
                ...
                var t = form["txtHandedDataToEmpNumber"];
                var dataToBeHanded = Convert.ToInt64(form["txtHandedDataToEmpNumber"]);

                var response = await GetApprovalForITClearance(empNum, ccNum, dataToBeHanded);
                ...
                if (formIdInput == 0)
                {
                    ...
                    item["ControllerName"] = "ITClearanceRequest";
                ...
                else
                {
                    ...
                    if (appRowIdInput != 0)
                    {
                        ...
                        ListItem listItem = listApprovalMaster.GetItemById(appRowIdInput);
        ...
        public List<string> GetApproverEmailList()
        {
        ...
        public async Task<dynamic> GetITClearanceDetails(int rowId, int formId)
        {
            ...
            try
            {
                ...
                var response2 = await client2.GetAsync("_api/web/lists/GetByTitle('ApprovalMaster')/items?$select=ApproverId,ApproverStatus,Modified,IsActive,Comment,NextApproverId,ApproverName,ApproverUserName,Level,Logic,TimeStamp,Designation,"
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<ResponseModel<List<ApprovalMatrix>>> GetApprovalForITClearance(long empNum, long ccNum, long dataToBeHanded)
        {
            try
            {
